...
%let _rcm_rx_ndc              = dat.rcm_rx_ndc                   ;
%let _rcm_utl_pos             = dat.rcm_utl_pos                  ;
...
%let _vdw_census_demog_acs      =  &_vdw_census_demog_acs        ;
%let _vdw_census_demog_dec      =  &_vdw_census_demog_dec        ;
